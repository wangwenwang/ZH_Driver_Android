...
import com.kaidongyuan.app.zhdriver.adapter.MainViewpageAdapter;
...
import com.kaidongyuan.app.zhdriver.serviceAndReceiver.GetuiIntentService;
import com.kaidongyuan.app.zhdriver.serviceAndReceiver.GetuiPushService;
import com.kaidongyuan.app.zhdriver.serviceAndReceiver.TrackingService;
import com.kaidongyuan.app.zhdriver.ui.base.BaseFragmentActivity;
import com.kaidongyuan.app.zhdriver.ui.fragment.IndexFragment;
import com.kaidongyuan.app.zhdriver.ui.fragment.MineFragment;
import com.kaidongyuan.app.zhdriver.ui.fragment.OrderFragment;
import com.kaidongyuan.app.zhdriver.ui.widget.IsScrollableViewPager;
...
public class MainActivity extends BaseFragmentActivity implements AsyncHttpCallback {
    ...
    private final String DestFileName="zhdriver.apk";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(!isAutoUpdate)
        {
            ...
            try {
                getApplicationContext().stopService(mLocationIntent);
    ...
    //       HashMap<String,Object> testmaps=SharedPreferencesUtils.getAllByBasesName("TestDatabase");
//        for (Map.Entry<String,Object> entry:testmaps.entrySet()){
//            MLog.e(entry.getKey()+entry.getValue().toString());
//        }
      //  SharedPreferencesUtils.ClearSharedPreferences("TestDatabase");
    }
