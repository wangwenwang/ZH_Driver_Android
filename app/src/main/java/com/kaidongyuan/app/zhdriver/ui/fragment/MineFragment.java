package com.kaidongyuan.app.zhdriver.ui.fragment;
...
import com.kaidongyuan.app.zhdriver.ui.activity.AboutActivity;
import com.kaidongyuan.app.zhdriver.ui.activity.FeedBackActivity;
import com.kaidongyuan.app.zhdriver.ui.activity.LoginActivity;
import com.kaidongyuan.app.zhdriver.ui.activity.MainActivity;
import com.kaidongyuan.app.zhdriver.ui.activity.OfflineMapActivity;
import com.kaidongyuan.app.zhdriver.ui.activity.UpdatePwdActivity;
...
//        }
    ...
    public void stopTrackService(){
        ...
        if (mLocationIntent==null){
            mLocationIntent=new Intent(this.getContext(),TrackingService.class);
        }
        try {
            this.getActivity().stopService(mLocationIntent);
            PushManager.getInstance().stopService(this.getActivity());
        }catch (Exception ex){
        }
...
//        btn_location.setSelected(isWorked("com.kaidongyuan.app.kdydriver.service.TrackingService"));
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.login_btn:
//              ActivitySwitcher.goLoginForResult(getActivity(), 1);
