 ...
 *客户资料
 */
public class Party_bakup implements java.io.Serializable {
	...
	public Long getEntIdx() {
		return entIdx;
	}

	public void setEntIdx(Long entIdx) {
		this.entIdx = entIdx;
	}
	...
	public void setBusinessIdx(Long businessIdx) {
	...
	public Long getOperatorIdx() {
		return operatorIdx;
	}

	public void setOperatorIdx(Long operatorIdx) {
