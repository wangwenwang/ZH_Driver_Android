...
import com.kaidongyuan.app.zhdriver.adapter.NotifyAdapter;
import com.kaidongyuan.app.zhdriver.adapter.NotifyOrderListAdapter;
import com.kaidongyuan.app.zhdriver.bean.order.Notify;
...
import com.kaidongyuan.app.zhdriver.ui.activity.NotifyActivity;
import com.kaidongyuan.app.zhdriver.ui.activity.OrderDetailActivity;
import com.kaidongyuan.app.zhdriver.ui.activity.OrderTrackCheckActivity;
...
public class IndexFragment extends BaseLifecyclePrintFragment implements AsyncHttpCallback,View.OnClickListener {
    ...
    private void initVpAd() {
        ...
        images.get(2).setImageResource(R.drawable.ad_pic_0);
        images.get(3).setImageResource(R.drawable.ad_pic_1);
        initpager();
    }
    /**
